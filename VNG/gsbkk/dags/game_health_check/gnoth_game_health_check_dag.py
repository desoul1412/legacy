...
# Pipeline configuration - GNOTH-specific layouts
pipeline = [
    # ETL Stage
    ...
    {'name': 'etl_campaign', 'type': 'etl',
     'layout': 'layouts/game_health_check/gnoth/etl/campaign.json'},
    
    # STD Stage
    {'name': 'std_active', 'type': 'etl',
     'layout': 'layouts/game_health_check/gnoth/std/active.json'},
    {'name': 'std_charge', 'type': 'etl',
     'layout': 'layouts/game_health_check/gnoth/std/charge.json'},
     {'name': 'std_retention', 'type': 'etl',
     'layout': 'layouts/game_health_check/gnoth/std/retention.json'},
    ...
    {'name': 'cons_package_performance', 'type': 'etl',
     'layout': 'layouts/game_health_check/gnoth/cons/package_performance.json'},
    {'name': 'cons_server_performance', 'type': 'etl',
     'layout': 'layouts/game_health_check/gnoth/cons/server_performance.json'},
]
